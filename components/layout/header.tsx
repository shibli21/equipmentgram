          ...
          >
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M.41.91a.833.833 0 0 1 1.18 0L6 5.322l4.41-4.41a.833.833 0 1 1 1.18 1.178l-5 5a.833.833 0 0 1-1.18 0l-5-5a.833.833 0 0 1 0-1.178Z"
                />
              </svg>
            </Link>
            ...
            {showModal && (
              <div
                ref={modalRef}
                x-show="dropdownOpen"
                className="absolute right-0 mt-4 flex w-[250px] flex-col gap-1 rounded-lg bg-white shadow-card"
              >
                <ul className="flex flex-col gap-5 border-b border-stroke py-[30px] px-6">
                  <li>
                    <Link
                      href="/"
                      className="flex items-center gap-3.5 text-sm font-medium text-body-color duration-300 ease-in-out hover:text-primary lg:text-base"
                    >
                      <svg
                ...
                <button
                  onClick={signOut}
                  className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium text-body-color duration-300 ease-in-out hover:text-primary lg:text-base"
                >
                  <svg
                    className="fill-current"
                    width="22"
...
function Navbar() {
  ...
  useOnClickOutside(modalRef, () => setNavbarOpen(false));
